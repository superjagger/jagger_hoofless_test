require_relative 'lib/jagger_hoofless_test/version'

Gem::Specification.new do |spec|
  spec.name          = "jagger_hoofless_test"
  spec.version       = JaggerHooflessTest::VERSION
  spec.authors       = ["111"]
  spec.email         = ["1336098842@qq.com"]

  spec.summary       = %q{jagger_hoofless_test} 
  spec.description   = %q{jagger_hoofless_test test gem push} 
  spec.homepage      = "https://github.com/superjagger/jagger_hoofless_test" 
  spec.license       = "MIT"
  spec.required_ruby_version = Gem::Requirement.new(">= 2.3.0")

  spec.metadata["allowed_push_host"] = "https://rubygems.org" 

  spec.metadata["homepage_uri"] = "https://github.com/superjagger/jagger_hoofless_test" 
  spec.metadata["source_code_uri"] = "https://github.com/superjagger/jagger_hoofless_test.git" 
  spec.metadata["changelog_uri"] =  "https://github.com/superjagger/jagger_hoofless_test/blob/main/CHANGELOG.md" 
  ...
  spec.add_dependency "jagger_thiogycolic_test", "~> 0.1"
end
